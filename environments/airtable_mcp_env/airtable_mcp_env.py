"""
Synthetic Airtable Environment for vf-eval

Usage:
    uv run vf-eval airtable-mcp-env -n 1 -r 1 -m <model> -b <base_url>
"""
...
class SyntheticMCPEnv(vf.ToolEnv):
    ...
    def __init__(
        self, synthetic_backend: SyntheticAirtable, max_turns: int = 10, **kwargs
    ):
